    ...
    void rotate(vector<vector<int>>& matrix) {
        ...
        for (size_t x = 0; x < size / 2; x = x++)
        {
            ...
            for (size_t y = x; y < size - x - 1; y++)
            {
                ...
                swap(matrix.at(x).at(y), matrix.at(size - y - 1).at(x));
                swap(matrix.at(size - y - 1).at(x), matrix.at(size - y - 1).at(x));
                swap(matrix.at(size - y - 1).at(size - x - 1), matrix.at(size - y - 1).at(x));
                swap(matrix.at(y).at(y), matrix.at(size - x - 1).at(x));
